...
export const commanderReferences: CommanderReference[] = [
  ...
  },
  {
    ...
    rarity: 'legendary',
    specialties: ['Cavalry', 'Garrison', 'Attack'],
  ...
  },
  {
    ...
    imageUrl: '',
    altNames: ['david', 'david iv', 'david the builder'],
  },
  {
    id: 'cao-cao',
    name: 'Cao Cao',
  ...
  // ============ ADDITIONAL LEGENDARY COMMANDERS ============
  {
    id: 'hayam-wuruk',
    name: 'Hayam Wuruk',
    title: 'Maharaja of Majapahit',
    rarity: 'legendary',
    specialties: ['Archer', 'Garrison', 'Attack'],
    imageUrl: '',
    altNames: ['hayam', 'wuruk'],
  },
  {
    id: 'alp-arslan',
    name: 'Alp Arslan',
    title: 'Heroic Lion',
    rarity: 'legendary',
    specialties: ['Archer', 'Skill', 'Attack'],
    imageUrl: '',
    altNames: ['arslan', 'alp'],
  },
  {
    id: 'gajah-mada',
    name: 'Gajah Mada',
    title: 'The Great Patih',
    rarity: 'legendary',
    specialties: ['Leadership', 'Versatility', 'Defense'],
    imageUrl: '',
    altNames: ['gajah', 'mada'],
  },
  {
    id: 'gonzalo-de-cordoba',
    name: 'Gonzalo de Cordoba',
    title: 'The Great Captain',
    rarity: 'legendary',
    specialties: ['Archer', 'Skill', 'Attack'],
    imageUrl: '',
    altNames: ['gonzalo', 'cordoba', 'gran capitan'],
  },
  {
    id: 'bertrand-du-guesclin',
    name: 'Bertrand du Guesclin',
    title: 'Eagle of Brittany',
    rarity: 'legendary',
    specialties: ['Cavalry', 'Skill', 'Attack'],
    imageUrl: '',
    altNames: ['bertrand', 'guesclin'],
  },
  {
    id: 'choe-yeong',
    name: 'Choe Yeong',
  ...
  {
    id: 'scipio-aemilianus',
    name: 'Scipio Aemilianus',
    title: 'Africanus the Younger',
    rarity: 'legendary',
    specialties: ['Infantry', 'Conquering', 'Defense'],
    imageUrl: '',
    altNames: ['aemilianus', 'scipio younger'],
  },
  {
    id: 'john-hunyadi',
    name: 'John Hunyadi',
    title: 'Defender of Christendom',
    rarity: 'legendary',
    specialties: ['Leadership', 'Conquering', 'Defense'],
    imageUrl: '',
    altNames: ['hunyadi', 'john'],
  },
  {
    id: 'stephen-iii',
    name: 'Stephen III',
    title: 'The Great',
    rarity: 'legendary',
    specialties: ['Leadership', 'Defense', 'Versatility'],
    imageUrl: '',
    altNames: ['stephen', 'stephen the great'],
  },
  {
    id: 'ragnar-lodbrok-prime',
    name: 'Ragnar Lodbrok Prime',
    title: 'Hairy Breeches Reborn',
    rarity: 'legendary',
    specialties: ['Leadership', 'Conquering', 'Attack'],
    imageUrl: '',
    altNames: ['ragnar prime', 'lodbrok prime'],
  },
  {
    id: 'siyaj-kak',
    name: "Siyaj K'ak'",
  ...
  },
  {
    ...
    title: 'First Emperor',
    rarity: 'legendary',
    specialties: ['Archer', 'Conquering', 'Versatility'],
    imageUrl: '',
    altNames: ['qin', 'shi huang', 'first emperor'],
  },
  {
    id: 'tokugawa-ieyasu',
    ...
    specialties: ['Infantry', 'Garrison', 'Defense'],
    imageUrl: '',
    altNames: ['tokugawa', 'ieyasu'],
  },
  {
    id: 'bai-qi',
    name: 'Bai Qi',
    title: 'The Human Butcher',
    rarity: 'legendary',
    specialties: ['Infantry', 'Conquering', 'Attack'],
    imageUrl: '',
    altNames: ['baiqi', 'bai'],
  },
  {
    ...
    specialties: ['Leadership', 'Conquering', 'Skill'],
    imageUrl: '',
    altNames: ['afonso', 'henriques'],
  },
  {
    id: 'archimedes',
    name: 'Archimedes',
    title: 'The Father of Mathematics',
    rarity: 'legendary',
    specialties: ['Leadership', 'Skill', 'Versatility'],
    imageUrl: '',
    altNames: ['archimedes'],
  },
  {
    ...
    title: 'The Great',
    rarity: 'legendary',
    specialties: ['Leadership', 'Gathering', 'Defense'],
    imageUrl: '',
    altNames: ['casimir'],
  },
  {
  ...
  },
  {
    id: 'gang-gamchan',
    name: 'Gang Gamchan',
    title: 'Defender of Goryeo',
    rarity: 'legendary',
    specialties: ['Cavalry', 'Defense', 'Skill'],
    imageUrl: '',
    altNames: ['gang', 'gamchan'],
  },
  {
    id: 'hector',
    name: 'Hector',
    ...
    rarity: 'legendary',
    specialties: ['Leadership', 'Defense', 'Skill'],
    imageUrl: '',
    altNames: ['hector'],
  },
  {
  ...
  // ============ ADDITIONAL EPIC COMMANDERS ============
  {
    id: 'diaochan',
    name: 'Diaochan',
    title: 'The Sable Cicada',
    rarity: 'epic',
    specialties: ['Leadership', 'Support', 'Versatility'],
    imageUrl: '',
    altNames: ['diao chan', 'diaochan'],
  },
  {
  ...
  },
  {
    ...
    title: 'Queen Mother',
    rarity: 'epic',
    specialties: ['Leadership', 'Skill', 'Support'],
    imageUrl: '',
    altNames: ['catherine', 'medici'],
  },
  {
    id: 'narses',
    name: 'Narses',
    title: 'The Hammer of the Goths',
    rarity: 'epic',
    specialties: ['Leadership', 'Attack', 'Skill'],
    imageUrl: '',
    altNames: ['narses'],
  },
  // ============ ADDITIONAL ELITE COMMANDERS ============
  {
    id: 'lancelot',
    name: 'Lancelot',
    title: 'Knight of the Round Table',
    rarity: 'elite',
    specialties: ['Cavalry', 'Attack', 'Skill'],
    imageUrl: '',
    altNames: ['lancelot'],
  },
  {
    ...
    title: 'Onna-musha',
    rarity: 'elite',
    specialties: ['Archer', 'Attack', 'Skill'],
    imageUrl: '',
    altNames: ['tomoe', 'gozen'],
  },
  {
    id: 'gaius-marius',
    name: 'Gaius Marius',
    ...
    rarity: 'elite',
    specialties: ['Leadership', 'Skill', 'Attack'],
    imageUrl: '',
    altNames: ['marius', 'gaius'],
  },
  {
    id: 'constance',
    name: 'Constance',
